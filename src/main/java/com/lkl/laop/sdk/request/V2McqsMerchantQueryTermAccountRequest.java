 ...
 * @description 终端结算账户查询
 */
public class V2McqsMerchantQueryTermAccountRequest extends V2CommRequest {
    ...
    public FunctionCodeEnum getFunctionCode() {
        return FunctionCodeEnum.API_V2_MCQS_MERCHANT_QUERYTERMACCOUNT;
    }
}
