 ...
 * @description 商户网点列表查询
 */
public class V2McqsMerchantQueryShopListByNumRequest extends V2CommRequest {
    ...
    public FunctionCodeEnum getFunctionCode() {
        return FunctionCodeEnum.API_V2_MCQS_MERCHANT_QUERYSHOPLISTBYNUM;
    }
}
