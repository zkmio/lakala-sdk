...
/**
 * @author nxj
 * @date 2024/3/25 10:17
 * @description 快捷直接支付
 */
public class V3IpsqpTransDirectlyQuickPayRequest extends V3CommRequest {
     ...
     * C
     */
    @JsonProperty("trade_biz_tp")
    private String tradeBizTp;
    ...
    public String getTradeBizTp() {
        return tradeBizTp;
    }

    public void setTradeBizTp(String tradeBizTp) {
        this.tradeBizTp = tradeBizTp;
    }
    ...
    public FunctionCodeEnum getFunctionCode() {
        return FunctionCodeEnum.API_V3_IPSQP_TRANS_DIRECTLYQUICKPAY;
    }
}
